...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("libraries/swfsrc/swfsrc.dat", __ASSET__libraries_swfsrc_swfsrc_dat);
		type.set ("libraries/swfsrc/swfsrc.dat", AssetType.TEXT);
...
@:keep @:bind #if display private #end class __ASSET__libraries_swfsrc_swfsrc_dat extends null { }
@:keep @:bind #if display private #end class __ASSET__libraries_swfsrc_json extends null { }
