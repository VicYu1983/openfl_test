...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("libraries/swfsrc/swfsrc.swf", Reflect.field (AssetType, "binary".toUpperCase ()));
			path.set ("libraries/swfsrc.json", "libraries/swfsrc.json");
			type.set ("libraries/swfsrc.json", Reflect.field (AssetType, "text".toUpperCase ()));
			
			library.set ("swfsrc", Reflect.field (LibraryType, "null".toUpperCase ()));
