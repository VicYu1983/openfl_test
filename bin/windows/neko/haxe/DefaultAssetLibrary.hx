...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("libraries/swfsrc/swfsrc.swf", "libraries/swfsrc/swfsrc.swf");
		type.set ("libraries/swfsrc/swfsrc.swf", AssetType.BINARY);
		path.set ("libraries/swfsrc.json", "libraries/swfsrc.json");
		type.set ("libraries/swfsrc.json", AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.FONT);
		id = "libraries/swfsrc/swfsrc.swf";
		path.set (id, id);
...
@:keep #if display private #end class __ASSET__assets_fonts_oxygen_bold_ttf extends lime.text.Font { public function new () { __fontPath = "assets/fonts/Oxygen-Bold.ttf"; name = "Oxygen Bold"; super (); }}
@:keep #if display private #end class __ASSET__assets_fonts_oxygen_ttf extends lime.text.Font { public function new () { __fontPath = "assets/fonts/Oxygen.ttf"; name = "Oxygen Regular"; super (); }}
@:keep #if display private #end class __ASSET__fonts_oxygen_bold_ttf extends lime.text.Font { public function new () { __fontPath = "fonts/Oxygen-Bold.ttf"; name = "Oxygen Bold"; super (); }}
@:keep #if display private #end class __ASSET__fonts_oxygen_ttf extends lime.text.Font { public function new () { __fontPath = "fonts/Oxygen.ttf"; name = "Oxygen Regular"; super (); }}
...
#if openfl
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_oxygen_bold_ttf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/Oxygen-Bold.ttf"; name = "Oxygen Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_oxygen_ttf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/Oxygen.ttf"; name = "Oxygen Regular"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__fonts_oxygen_bold_ttf extends openfl.text.Font { public function new () { __fontPath = "fonts/Oxygen-Bold.ttf"; name = "Oxygen Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__fonts_oxygen_ttf extends openfl.text.Font { public function new () { __fontPath = "fonts/Oxygen.ttf"; name = "Oxygen Regular"; super (); }}
